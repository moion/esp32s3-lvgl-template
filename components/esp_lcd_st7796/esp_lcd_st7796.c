...
esp_err_t esp_lcd_new_panel_st7796(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel, uint8_t rot)
{
...
//  {cmd, { data }, data_size, delay_ms}
    ...
    {0x36, (uint8_t []){0x40 | 0x08}, 1, 0},
    //{0x36, (uint8_t []){0x20 | 0x08}, 1, 0},
    //{0x36, (uint8_t []){0x80 | 0x08}, 1, 0},
    //{0x36, (uint8_t []){0x40 |0x20| 0x80 | 0x08}, 1, 0},
...
static esp_err_t panel_st7796_init(esp_lcd_panel_t *panel)
{
    ...
    if(st7796->roatation == 1){
        ((uint8_t *)init_cmds[14].data)[0] = 0x40 |0x20| 0x80 | 0x08;
    }else if(st7796->roatation == 2){
        ((uint8_t *)init_cmds[14].data)[0] = 0x80 | 0x08;
    }else if(st7796->roatation == 3){
        ((uint8_t *)init_cmds[14].data)[0] = 0x20 | 0x08;
    }
